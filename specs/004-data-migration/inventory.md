...
- [ ] **T301 لم يُغلق بهذه النسخة.** حسابُ قراءةٍ فقط على الخادم الحيّ شرطٌ
      لمعيار D6 («لا كتابة واحدة على قاعدة v1، يُثبت بحساب قراءة فقط»)،
      والنسخة تُغني عن الاتصال لا عن الإثبات. ويبقى السؤال للمالك: هل يجري
      الترحيل من هذه النسخة أم من الخادم؟ النسخةُ أأمن — لا اتصال بالإنتاج
      أصلاً — لكنها **لقطةٌ بتاريخ**، وكل ما يقع بعد 2026-09-05 لا تراه.
