...
#
# والمنافذ منها ما يحظره المتصفّح نفسه: Chrome يرفض 5060 بـ`ERR_UNSAFE_PORT`
# لأنه محجوزٌ لـSIP، ورفضُه يسبق الخادمَ فلا يظهر في أي سجل. فالمذكورةُ هنا
# منافذُ آمنة، وإضافةُ واحدٍ جديد تمرّ على تلك القائمة أولاً.
