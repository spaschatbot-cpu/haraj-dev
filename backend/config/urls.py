...
# ‏الوسائط في التطوير وحده.
#
# لم يكن شيءٌ يخدم `MEDIA_URL`، فصورةٌ مرفوعة تُخزَّن على القرص ويُبنى رابطها
# ويُرسَل في البطاقة — **ويردّ الخادم 404**. أي أن رفع الصور كان يبدو ناجحاً
# في الاختبارات (وهي تقرأ القرص) وفاشلاً في المتصفّح وحده، وهو أسوأ ترتيبٍ
# ممكن: العطل لا يظهر إلا لمن ينظر بعينه.
#
# **وتحت `DEBUG` وحده، وهذا شرطٌ لا تزيين:** `django.views.static.serve` غير
# مخصّص للإنتاج، وخدمةُ ملفّاتٍ رفعها مستخدمون عبر Django هي الطريق الذي
# أوصل ويبشلّ v1 (T912). في الإنتاج تخدمها البنية — S3 أو خادم أمامي — لا
# هذا السطر.
if settings.DEBUG:
