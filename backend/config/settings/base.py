...
# --------------------------------------------------------------------------
# الجدولة الدوريّة — ما يجب أن يقع بلا أن يفتح أحدٌ صفحة.
#
# `auctions.run_calendar` كانت مكتوبةً بالكامل — بقفلٍ يمنع تشغيلين، وبترتيبٍ
# يبدأ قبل أن يُنهي — **ولا شيء ينادينها**. فكانت دورةُ حياة المزاد لا تتحرّك
# إلا حين يفتح موظّفٌ شاشةً تنادي `engine.tick()`: مزادٌ حان وقتُه ليلاً يبقى
# «قريباً» حتى يفتح أحدٌ اللوحة صباحاً، ومزادٌ انتهى يبقى «جارياً» يقبل مزايدةً
# لا يجوز أن يقبلها. وقد وقع الاثنان في هذه القاعدة: مزادٌ بدأ وقتُه ولم يُفعَّل،
# وآخرُ انتهى وحالتُه `live`.
#
# ودقيقةً واحدة لا أقلّ: المهمّة تقرأ صفّين وتكتب ما استحقّ، والدقيقةُ هي أقصى
# ما يتأخّره مزادٌ عن بدايته — وهو ما يقبله المزايد.
CELERY_BEAT_SCHEDULE = {
    "auctions-run-calendar": {
        "task": "auctions.run_calendar",
        "schedule": 60.0,
    },
}
