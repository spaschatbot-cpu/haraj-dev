"""إدارة المشرفين — قائمةُ الطاقم الإداري وأدوارهم. T830-ج.
...
def page_control(request):
    """التحكم في صفحات المستخدمين — الاستثناءات فوق الدور، **مسمّاةً**. T830-ﻫ.
...
def settings_page(request):
    """الإعدادات — الحساب والصلاحيات والمظهر، وما لكلٍّ منها من شاشة. T830-ﻫ.
