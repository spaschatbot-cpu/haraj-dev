...
#: **دفترُ التأمينات**، وشاشتُه «سجل المحفظة» (`console:money-ledger` — وقد
#: ابتلعت «تقرير المحفظة» في T935)
...
#: الرقمُ نفسُه الذي يحرسه `money.view` في «سجل المحفظة» بجوارها، **وبالدالّة
#: نفسِها** (`money.wallet_rows`). قِيس على `haraj2_t307` في ١٤ سبتمبر ٢٠٢٦.
