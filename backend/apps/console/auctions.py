...
def vehicle_state(request, pk: int):
    ...
    if (
        ...
        messages.error(
            request,
            # **واسمُ القدرة كما في `permissions.py` لا اسمُ شاشة.** كان
            # «اتخاذ القرار» — وهو اسمُ **شاشتين** اليوم، فيقرؤه الموظّفُ
            # وجهةً لا صلاحيةً ويذهب يبحث عنها. والقدرةُ اسمُها
            # `partners.decide` = «قرارات الشريك واختيار العروض».
            "قرارُ قبولِ العرض أو رفضه يحتاج صلاحية «قرارات الشريك واختيار "
            "العروض» — يُتَّخذ من شاشة العروض.",
        )
