    ...
    if sees_auctions:
        ...
        board.stats.append(
            Stat(
                ...
                # كانت البطاقةُ الوحيدةَ بلا وجهة: رقمٌ يُقرأ ولا يُفتح، وسبعُ
                # بطاقاتٍ حولَه كلُّها أبواب. و«تحليل المزايدات» هي شاشتُه —
                # تقرأ العددَ نفسَه من المصدر نفسِه وتقسمه على حالاته.
                reverse("console:analytics-bids"),
                "auction",
                "gavel",
                "تحليل المزايدات",
