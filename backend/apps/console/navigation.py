...
PAGES: tuple[Page, ...] = (
    ...
    # «احصائيات المزاد النشط» كانت أوّلَ هذا القسم، ودُمجت في «المزاد الجاري»
    # (T938) — والسببُ عند صفّها هناك.
    Page(
        "console:analytics",
        "لوحة التقارير",
        Capability.AUCTIONS_VIEW,
    ...
    # «تحليل المزايدات» و«تقرير المزايدات» كانتا هنا، وحُذفتا بطلب المالك
    # (١٨ سبتمبر ٢٠٢٦، T939).
    #
    # وما تبقّى في القسم تقاريرُ عن **المال والمزادات**: لوحةُ التقارير وتقريرُ
    # الأرباح. والمزايداتُ تُقرأ حيث تقع: في «المزاد الجاري» بأرقامها لكلّ
    # مزاد، وفي «مزايدات المركبة» صفّاً صفّاً، وفي «تقرير مزايدات مستخدم»
    # لشخصٍ بعينه (قسم الأعضاء) — وهذه الأخيرةُ **باقية**، فمن سأل عن مزايدٍ
    # يعرف اسمَه أو جوّالَه ما زال له باب.
