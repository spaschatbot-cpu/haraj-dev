...
PAGES: tuple[Page, ...] = (
    ...
    #
    # وأبوها كان «مزايدات المزاد الجاري» وحُذفت في ١٧ سبتمبر ٢٠٢٦، فصار
    # الأبُ «مزايدات حسب المزاد» — وإلّا أشار زرُّ الرجوع إلى مسارٍ لا وجود
    # له، و`capability_for` ترفع عند الإقلاع على أبٍ مفقود.
    Page(
        "console:vehicle-bids",
        "مزايدات السيارات",
        Capability.AUCTIONS_VIEW,
        "",
        parent="console:auction-bids-index",
    ),
    Page(
