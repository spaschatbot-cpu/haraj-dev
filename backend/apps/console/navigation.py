...
PAGES: tuple[Page, ...] = (
    ...
    Page(
        ...
        # **«قرارات الشريك» لا «اتخاذ القرار»** — T966. الاسمُ الثاني انتقل
        # إلى `console:owners-console` بقرار المالك، وصفّان في الشريط باسمٍ
        # واحدٍ أسوأُ من اسمٍ غيرِ دقيق: من يبحث عن شاشته يجد اثنتين ولا شيءَ
        # يفرّق بينهما إلّا القسم.
        #
