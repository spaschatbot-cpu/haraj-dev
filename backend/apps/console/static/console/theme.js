...
(function () {
  ...
  var ALLOWED = {
    ...
    accent: ["azure", "sea", "gold", "violet", "teal", "emerald", "amber", "rose"],
  ...
  var DEFAULTS = {
    ...
    sidebar: "auto",
    /* **مطويٌّ افتراضاً، ينفتح بالمرور** — قرارُ المالك في ١٧ سبتمبر ٢٠٢٦:
       «خلي دي الطبيعة بتاعة السايد بار». وكان `full`، أي أن ٣٠٤ بكسلاً من
       عرض كل شاشةٍ تذهب إلى قائمةٍ تُقرأ مرّةً عند الانتقال — والمرورُ
       بالمؤشّر يفتحها بأسمائها فوق المحتوى بلا أن يزيحه.
       ومن يريدها مفتوحةً ثابتةً يضغط مفتاحَ الطيّ، ويُحفظ اختيارُه. */
    nav: "mini",
