...
const nextConfig: NextConfig = {
  ...
  /**
   * ‏**رفعُ الوثائق يمرّ بفعل خادم** («المستندات» في «حسابي»)، وسقفُ أفعال
   * الخادم ١ ميجابايت افتراضاً — وصورةُ آيبانٍ من جوّالٍ تتجاوزه، فيُرفض الرفعُ
   * قبل أن يبلغ الخلفيّة بجملةٍ لا يفهمها العميل. والسقفُ الحقيقيّ عند الخلفيّة
   * (`UPLOAD_MAX_BYTES` = ١٠ ميجابايت، ورسالتُها عربيّةٌ تسمّي الحدّ)؛ فهذا يزيد
   * عليه هامشَ ترويسات `multipart` وحدَه، ونطاقُ nginx ٢٥ ميجابايت فوقهما.
   */
  experimental: {
