...
abstract interface class WalletRepository {
  ...
  /// يُلغي نيّةَ شحنٍ معلّقة، ويُرجعها كما صارت.
  ///
  /// ولماذا زرٌّ أصلاً: نيّةٌ بدأها عميلٌ ثم عدل تبقى `pending` إلى الأبد،
  /// **ورابطُ البوّابة عليها يقبل مالَه بعد شهر** — يدفع لطلبٍ نسيه. الإلغاءُ
  /// نصفُ الجواب، ونصفُه الآخر مهلةٌ في الخلفية لمن لم يُلغِ ولم يدفع.
  Future<TopUp> cancelTopUp(String reference);

  /// يفتح طلبَ استردادِ تأمينٍ بمبلغٍ وملاحظة.
  ///
  /// **بلا `Snapshot`**: فعلٌ يحرّك مالاً، وصمتُ الخادم فيه ليس «لا شيء حدث».
  /// والمبلغُ نصٌّ كما تكتبه الخلفيةُ وتقرؤه — لا `double` يفقد قرشاً في
  /// الطريق (المادة ٣-٢).
