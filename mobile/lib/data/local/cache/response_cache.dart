...
abstract interface class ResponseCache {
  ...
  /// يمحو مفتاحاً واحداً — بعد فعلٍ يعرف أنه أبطل شاشةً بعينها.
  ///
  /// و`clear()` لا تصلح لهذا: سدادُ فاتورةٍ يُبطل الفواتيرَ والمشترياتِ
  /// والمحفظة، **ولا يُبطل** مشاركاتي ولا الكتالوج — ومحوُ الكلّ يجعل كلّ
  /// شاشةٍ يفتحها العميل بعدها شاشةً بيضاء تنتظر الشبكة. والكاشُ شبكةُ أمانٍ
  /// لصمت الخادم، فمحوُه بلا سببٍ يُضعف ما وُجد له.
